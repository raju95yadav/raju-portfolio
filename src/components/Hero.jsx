        ...
        <div className="lg:col-span-7 space-y-6 text-left order-2 lg:order-1 animate-slide-up">
          ...
          <div className="space-y-2">
            ...
            <div className="h-10 sm:h-12 flex items-center">
              <span className="text-xl sm:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400">
                {text}
              </span>
          ...
          <p className="text-base sm:text-lg text-slate-700 dark:text-slate-400 max-w-xl leading-relaxed">
            I build scalable full-stack applications with real-time features,
            authentication, file sharing, and responsive interfaces. Familiar with JavaScript, React, Node.js,
            Express, MongoDB, and basic DSA concepts. Passionate about improving development skills and creating practical
            solutions.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <a
              href="https://raw.githubusercontent.com/raju95yadav/raju_resume/main/raju_resume.pdf"
              target="_blank"
              rel="noopener noreferrer"
